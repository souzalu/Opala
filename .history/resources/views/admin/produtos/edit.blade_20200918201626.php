        ...
        <form method="POST" action="/admin/produtos/edit/{{ $produto->id }}" enctype="multipart/form-data">
            ...
            <div class="form-row text-center">
                ...
                <div class="form-group col-md-3 offset-sm-0">
                    ...
                    <input type="text" name="estoque" class="form-control" id="estoque" value="{{ $produto->estoque }}"
                        required>
                </div>
                ...
                <div class="form-group col-md-3 offset-sm-3">
                    ...
                    <select class="form-control" id="categoria_id" name="categoria_id">
                        ...
                        @foreach ($categorias as $c)
                            <option value="{{ $c->id }}"
                                {{ $c->id == old('categoria_id', $produto->categoria_id) ? 'selected' : '' }}>{{ $c->nome }}
                            </option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group col-md-6 offset-md-3">
                    ...
                    <textarea class="form-control" name="descrição" id="descrição"
                        rows="3">{{ $produto->descrição }}</textarea>
                </div>
            </div>
