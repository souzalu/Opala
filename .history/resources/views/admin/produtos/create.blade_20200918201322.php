        ...
        <form method="POST" action="/produto/store" enctype="multipart/form-data">
            ...
            <div class="form-row text-center">
                ...
                <div class="form-group col-md-6 offset-md-3">
                    ...
                    <textarea class="form-control" name="descrição" id="descrição" rows="3" value=""></textarea>
                </div>
            </div>
            ...
            <div class="form-row justify-content-center">
                <div class="col-md-4 mt-2">
                    <button class="btn btn-dark btn-lg btn-block" href="{{ route('create') }}" type="submit">Cadastrar
                        Produto</button>
                </div>
            </div>
        </form>
